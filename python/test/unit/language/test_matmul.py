...
def test_preshuffle_scale_mxfp_cdna4(M, N, K, BLOCK_M, BLOCK_N, BLOCK_K, mfma_nonkdim, preshuffle, device):
    ...
    grid = (triton.cdiv(M, BLOCK_M) * triton.cdiv(N, BLOCK_N), 1)
    k = _gemm_afp4_wfp4_kernel_preshuffled_scales_cdna4[grid](
        x,
        w,
        triton_out,
        x_scales_triton,
        ...
        triton_out.stride(0),
        triton_out.stride(1),
        x_scales_triton.stride(0),
        x_scales_triton.stride(1),
        w_scales_triton.stride(0),
        w_scales_triton.stride(1),
        BLOCK_M,
        BLOCK_N,
        BLOCK_K,
        mfma_nonkdim,
