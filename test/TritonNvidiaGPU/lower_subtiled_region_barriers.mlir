...
// Barrier values are passed through inputs to satisfy IsolatedFromAbove.
// The lowering pass clones them for each tile.
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func @lower_epilogue_with_inline_barriers(
    ...
    ttng.subtiled_region
      ...
      ^bb0(%arg0: tensor<128x64xf32, #linear>, %arg1: tensor<128x64xf32, #linear>, %arg2: !ttg.memdesc<128x64xf16, #shared, #smem, mutable>, %arg3: !ttg.memdesc<128x64xf16, #shared, #smem, mutable>, %arg4: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg5: i32):
      ...
      } tile(%t0: tensor<128x64xf32, #linear>, %t1: !ttg.memdesc<128x64xf16, #shared, #smem, mutable>, %tbar: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %tphase: i32, %tidx: i32) {
        ttng.wait_barrier %tbar, %tphase : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
        ...
        ttng.arrive_barrier %tbar, 1 : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func @lower_tma_store_with_inline_barriers(
    ...
    ttng.subtiled_region
      ...
      } tile(%t0: !ttg.memdesc<128x64xf16, #shared_b, #smem_b, mutable>, %t1: i32, %tdesc: !tt.tensordesc<tensor<128x64xf16, #shared_b>>, %tbar: !ttg.memdesc<1xi64, #shared1_b, #smem_b, mutable>, %tphase: i32, %tidx: i32) {
        ttng.wait_barrier %tbar, %tphase : !ttg.memdesc<1xi64, #shared1_b, #smem_b, mutable>
        ttng.async_tma_copy_local_to_global %tdesc[%t1, %t1] %t0 : !tt.tensordesc<tensor<128x64xf16, #shared_b>>, !ttg.memdesc<128x64xf16, #shared_b, #smem_b, mutable>
        ttng.arrive_barrier %tbar, 1 : !ttg.memdesc<1xi64, #shared1_b, #smem_b, mutable>
        ttng.subtiled_region_yield
      } teardown {
        ttng.subtiled_region_yield
      }
